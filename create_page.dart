...
import 'quiz_code_page.dart'; // Import the QuizCodePage
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      DropdownButton<int>(
                        ...
                        items: List.generate(question.answerControllers.length, (index) {
...
class Question {
  ...
  final List<TextEditingController> answerControllers = List.generate(4, (index) => TextEditingController());
